                    ...
                    <div class="content">
                        ...
                        <form method="POST" action="{{ route('add_subscriber') }}">
                            ...
                            <div class="input-group">
                             ...
                             <button type="submit" class="btn" type="submit">Subscribe Now</button>
                             </span>
                            </div>
                        </form>
                    </div>
...
{{--                    unsubscribe--}}
                    <div class="content">
                        <h2>You want to unsubscribe ?</h2>
                        <form method="POST" action="{{ route('unsubscribe') }}">
                            @csrf
                            <div class="input-group">
                                <input type="email" name="email" class="form-control" placeholder="Enter your email">
                                <span class="input-group-btn">
                             <button type="submit" class="btn" type="submit">unSubscribe Now</button>
                             </span>
                            </div>
                        </form>
                    </div>
